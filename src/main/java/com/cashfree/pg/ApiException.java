...
import com.cashfree.pg.gatewayinterface.CFError;
...
public class ApiException extends Exception {
    ...
    private CFError customError;

    public ApiException(String message, Integer code, CFError errorObject) {
        super(message);
        this.code = code;
        this.responseBody = String.valueOf(errorObject);
        this.responseHeaders = responseHeaders;
    }
    /**
     * Constructor for ApiException.
