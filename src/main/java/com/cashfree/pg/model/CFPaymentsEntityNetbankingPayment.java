...
public class CFPaymentsEntityNetbankingPayment {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<CFPaymentsEntityNetbankingPayment>() {
                        @Override
                        public void write(JsonWriter out, CFPaymentsEntityNetbankingPayment value)
                                throws IOException {
    ...
    /**
     * Create an instance of CFPaymentsEntityNetbankingPayment given an JSON string
     *
    ...
    /**
     * Convert an instance of CFPaymentsEntityNetbankingPayment to an JSON string
     *
     * @return JSON string
     */
